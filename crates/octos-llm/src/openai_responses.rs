    ...
    ChatResponse {
        ...
        usage: TokenUsage {
            input_tokens: resp
                .usage
                .input_tokens
                .saturating_sub(resp.usage.input_tokens_details.cached_tokens)
                .saturating_sub(resp.usage.input_tokens_details.cache_write_tokens),
            cache_read_tokens: resp.usage.input_tokens_details.cached_tokens,
            cache_write_tokens: resp.usage.input_tokens_details.cache_write_tokens,
